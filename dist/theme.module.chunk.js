...
var ColorsComponent = /** @class */ (function () {
    ...
    ColorsComponent.prototype.themeColors = function () {
        Array.from(document.querySelectorAll('.theme-color')).forEach(function (el) {
            ...
            var background = Object(__WEBPACK_IMPORTED_MODULE_1__coreui_coreui_js_src_utilities___["a" /* getStyle */])('background-color', elem);
            var table = document.createElement('table');
            table.innerHTML = "\n        <table class=\"w-100\">\n          <tr>\n            <td class=\"text-muted\">HEX:</td>\n            <td class=\"font-weight-bold\">" + Object(__WEBPACK_IMPORTED_MODULE_1__coreui_coreui_js_src_utilities___["c" /* rgbToHex */])(background) + "</td>\n          </tr>\n          <tr>\n            <td class=\"text-muted\">RGB:</td>\n            <td class=\"font-weight-bold\">" + background + "</td>\n          </tr>\n        </table>\n      ";
